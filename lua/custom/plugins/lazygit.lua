...
-- 快捷键
vim.keymap.set('n', '<leader>tg', '<Cmd>LazyGit<CR>', { desc = '[T]erminal Lazy[G]it' })
vim.keymap.set('n', '<leader>gf', '<Cmd>LazyGitFilter<CR>', { desc = 'LazyGit [F]ilter (project commits)' })
vim.keymap.set('n', '<leader>gc', '<Cmd>LazyGitFilterCurrentFile<CR>', { desc = 'LazyGit [C]urrent file commits' })
